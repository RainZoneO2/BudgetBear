...
export default function () {
  ...
  return (
    <form
      className="flex gap-3 flex-col max-w-[350px] w-full"
      onSubmit={submit}
    >
      ...
      <div className="flex gap-3 flex-col max-w-[350px] w-full">
        ...
        {errors?.user?.email?.message && (
          <p className="first-letter:capitalize text-[red]">
            Email: {errors.user.email.message}
          </p>
        )}
        <input
          className="ctext-base py-1 px-3 border border-[#CCC] border-solid rounded w-full"
        ...
        <button
          className="py-0.5 border border-solid border-black rounded bg-[#efefef] hover:bg-[#e5e5e5]"
